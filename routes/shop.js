...
router.get('/comments', isAuth, shopController.getComments);

router.get('/add-comment/:productId', isAuth, shopController.getAddComment);

router.post('/add-comment', isAuth, shopController.postAddComment);
